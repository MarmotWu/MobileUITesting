...
sleep(5)
touch(Template(r"tpl1584518538792.png", record_pos=(-0.007, -0.625), resolution=(1080, 2244)))
touch(Template(r"tpl1584518544672.png", record_pos=(-0.158, -0.482), resolution=(1080, 2244)))
