...
#构件
touch(Template(r"tpl1584070288703.png", record_pos=(-0.12, 0.674), resolution=(1080, 2244)))
sleep(2)
touch(Template(r"tpl1584070359842.png", record_pos=(-0.02, -0.643), resolution=(1080, 2244)))
touch(Template(r"tpl1584070374849.png", record_pos=(-0.011, -0.645), resolution=(1080, 2244)))
touch(Template(r"tpl1584070380831.png", record_pos=(0.013, -0.516), resolution=(1080, 2244)))
touch(Template(r"tpl1584070394959.png", record_pos=(0.027, -0.256), resolution=(1080, 2244)))
touch(Template(r"tpl1584070400534.png", record_pos=(0.058, -0.129), resolution=(1080, 2244)))
touch(Template(r"tpl1584070408859.png", record_pos=(0.088, -0.005), resolution=(1080, 2244)))
sleep(2)
...
sleep(1)
assert_exists(Template(r"tpl1584071048356.png", record_pos=(0.013, -0.625), resolution=(1080, 2244)), "未获取到创建的协作")
touch(Template(r"tpl1584071048356.png", record_pos=(0.013, -0.625), resolution=(1080, 2244)))
sleep(1)
...
touch(Template(r"tpl1584070380831.png", record_pos=(0.013, -0.516), resolution=(1080, 2244)))
touch(Template(r"tpl1584070394959.png", record_pos=(0.027, -0.256), resolution=(1080, 2244)))
assert_exists(Template(r"tpl1584070400534.png", record_pos=(0.058, -0.129), resolution=(1080, 2244)),"反查构件类型失败")
